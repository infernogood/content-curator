...
# Минимальная длинная сторона растрового изображения (в пикселях) для публикации.
# Техническая константа, не пользовательская настройка.
MIN_MEDIA_DIMENSION: int = 600
